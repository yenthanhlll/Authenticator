...
<tag:page onload="init"  useDateRange="true" viewUriPrefix="/web/manager/servicelog/rest" hasDetailsBox="true">
...
function init() {
	$("#exportExcelBtn").on('click', function(){
		GPTWR_DOWNLOAD('/web/manager/servicelog/rest/export', 'serviceLogForm');
	});
...
<jsp:body>
  <!-- =============================================== -->
	...
	<section class="content-header">
		<h1><fmt:message key="servicelog"/> <small><fmt:message key="servicelog.desc"/></small></h1>
		<ol class="breadcrumb">
			<li class="active"><fmt:message key="nav.title.log"/></li>
			<li class="active"><i class="fa fa-list-alt"></i> <fmt:message key="nav.serviceLog" /></li>
		</ol>
	</section>
	...
	<section class="content">
		...
		<form id="serviceLogForm" method="POST" class="form-inline" role="form">
		...
		<div class="col-md-10">
        	<div class="box mmth-box">
            	<div class="box-header with-border">
              	<h3 class="box-title"><fmt:message key="servicelog.list"/></h3>
